...
<body borderline="0" style="background-color: white; padding:3vh; padding-top:0;">
    ...
    <h2 style="margin-top:2vh;margin-bottom:2vh;">All users</h2>
    <div id="activities"><?php include "../functions.php"; showUsers(1); ?></div>
...
<?php
    if(isset($_POST["options"])) {
        echo "<script>alert(\"{$_POST["options"]}\")</script>";
        changeRole();
        exit();
    }
?>