...
<body borderline="0" style="background-color: white; padding:3vh; padding-top:0;">
    ...
    <h2 style="margin-top:2vh;margin-bottom:2vh;">All activities</h2>
    <div id="activities"><?php include "../functions.php"; showAllActivities();?></div>
</body>
...
<?php
    ...
    if(isset($_POST["save"])) {
        changeWorker($_POST["save"], $_POST['worker'],0);
        exit();
    }
    ...
    if(isset($_POST["sendDate"])) {
        changeDate($_POST["sendDate"], $_POST["date"],0);
        exit();
    }
