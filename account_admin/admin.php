    ...
    <div class="container-page">
        ...
        <div class="container-activities">
            <div class="container-buttons">
                <a href="adminAll.php" target="activity-frame" style="border-right:1px solid black; text-decoration:none; color: black;" class="activity"><div>All</div></a>
                <a href="adminNew.php" target="activity-frame" style="border-right:1px solid black; text-decoration:none; color: black;" class="activity"><div>New</div></a>
                <a href="adminActivated.php" target="activity-frame" style="border-right:1px solid black; text-decoration:none; color: black;" class="activity"><div>Activated</div></a>
                <a href="adminResolved.php" target="activity-frame" style="border-right:1px solid black; text-decoration:none; color: black;" class="activity"><div>Solved</div></a>
                <a href="Users.php" target="activity-frame" style="text-decoration:none; color: black;" class="activity"><div>Users</div></a>
            </div>
            <iframe frameborder="0" src="adminAll.php" height="90%" name="activity-frame"></iframe>
        </div>
    </div>
</body>
</html>
